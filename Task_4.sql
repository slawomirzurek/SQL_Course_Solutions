...
ROUND(COUNT(o.ORDER_ID)/TO_NUMBER(SUBSTR(1+(SELECT o.ORDER_DATE FROM ORDERS o
    ...
    WHERE PROMOTION_ID IS NULL ORDER BY ORDER_ID ASC FETCH FIRST ROW ONLY),1,10)),2) AS "Średnia liczba zamówieñ na dzieñ",
ROUND(SUM(o.ORDER_TOTAL),2) AS "Wartość wszystkich zamówieñ",
ROUND(SUM(o.ORDER_TOTAL)/COUNT(o.ORDER_ID),2) AS "Średnia wartość zamówienia"
FROM ORDERS o 
JOIN CUSTOMERS c ON c.CUSTOMER_ID = o.CUSTOMER_ID
...
ROUND(COUNT(o.ORDER_ID)/TO_NUMBER(SUBSTR(1+(SELECT o.ORDER_DATE FROM ORDERS o
    ...
    WHERE PROMOTION_ID = 1 ORDER BY ORDER_ID ASC FETCH FIRST ROW ONLY),1,10)),2) AS "Średnia liczba zamówieñ na dzieñ",
ROUND(SUM(o.ORDER_TOTAL),2) AS "Wartość wszystkich zamówieñ",
ROUND(SUM(o.ORDER_TOTAL)/COUNT(o.ORDER_ID),2) AS "Średnia wartość zamówienia"
FROM ORDERS o 
JOIN CUSTOMERS c ON c.CUSTOMER_ID = o.CUSTOMER_ID
...
ROUND(COUNT(o.ORDER_ID)/TO_NUMBER(SUBSTR(1+(SELECT o.ORDER_DATE FROM ORDERS o
    ...
    WHERE PROMOTION_ID = 2 ORDER BY ORDER_ID ASC FETCH FIRST ROW ONLY),1,10)),2) AS "Średnia liczba zamówieñ na dzieñ",
ROUND(SUM(o.ORDER_TOTAL),2) AS "Wartość wszystkich zamówieñ",
ROUND(SUM(o.ORDER_TOTAL)/COUNT(o.ORDER_ID),2) AS "Średnia wartość zamówienia"
FROM ORDERS o 
JOIN CUSTOMERS c ON c.CUSTOMER_ID = o.CUSTOMER_ID
